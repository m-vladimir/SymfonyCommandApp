...
include_once $this->targetDirs[3].'/src/Repository/AuthorRepository.php';

return $this->privates['App\\Repository\\AuthorRepository'] = new \App\Repository\AuthorRepository(($this->services['doctrine'] ?? $this->load('getDoctrineService.php')));
